...
# Use Bresenham algorithm to check if two points are safe to connect in 2D grid
...
# Use polygon representation of obstacles to check if two points in 3D can be connected
...
#            print("can_connect : ", p1, p2)
            prev_safe_path = p2
            i += 1
        else:
#            print("can't_connect : ", p1, p2)
